<html>
    ...
    <body>
        <center>
            <h1>Add New Benefits</h1>
        <form method="post" action="insertAction.php?action=benefits" class="white-box">
            
            Benefits ID:<input type="text" name="benefitsID" required><br><br><br><br>
            ...
            Details:<input type="text" name="details" required><br><br><br><br>
